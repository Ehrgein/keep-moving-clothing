            ...
            .map((item) => (
              ...
              >
                <Link to={`products/${item.categories}/${item.id}`}>
                  <img
                    className="mobileL:h-40 mobileL:w-40 mobilem:h-36 mobilem:w-36 fold:w-[130px] fold:h-[130px] my-4"
                    src={item.prod_img}
                  />
                </Link>
                <p className="text-center mobilem:text-base mobilexs:text-sm capitalize mt-1 mr-1">
                  {" "}
                  {item.brand}
                </p>
                ...
                <p className="text-center mobilem:text-base font-semibold mt-1 mobilem:mt-5 mobilexs:mt-3">
                  {" "}
                  $ {item.price}
                </p>
