      ...
      <div className="laptopL:hidden flex justify-between items-center mobilem: mobilexs:h-16 bg-black text-white mx-auto sticky z-10 top-0">
        ...
        <div className="text-sm flex">
          <Link to="/account/wishlist">
            <AiOutlineHeart
              aria-label="wishlist"
              className="mobilexs:w-5 mobilexs:h-5 mobileL:h-6 mobileL:w-6"
            />
          </Link>
          <CartSlider />
          <Link to="/account">
            <VscAccount
              aria-label="account"
              className="mobilem:mr-2 tablet:w-[25px] h-auto mobilexs:w-5 mobilexs:h-5 mobileL:h-6 mobileL:w-6 mobilexs:mr-1"
            />
          </Link>
        </div>
      </div>
