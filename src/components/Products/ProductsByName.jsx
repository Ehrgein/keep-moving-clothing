...
function ProductsByName() {
  ...
  const designerproducts = productscontext.filter((word) =>
    word.name.toUpperCase().includes("Garret".toUpperCase())
  );
  ...
  const sortedItemsSelect = (e) => {
    ...
    if (value === "ascending") {
      ...
      const ascendingOrder = [...designerproducts].sort(
        (a, b) => a.price - b.price
      );
    ...
    if (value === "descending") {
      ...
      const descendingOrder = [...designerproducts].sort(
        (a, b) => b.price - a.price
      );
    ...
    if (value === "az") {
      ...
      const ascendingaz = [...designerproducts].sort((a, b) =>
        a.name > b.name ? 1 : -1
      );
    ...
    if (value === "za") {
      ...
      const descendingza = [...designerproducts].sort((a, b) =>
        a.name > b.name ? -1 : 1
      );
