        ...
        <div className='hidden laptop:flex'>
            ...
            <div className='flex flex-wrap justify-center desktop:pl-16 desktop:my-10 laptopL:my-6 laptopL:mx-2 laptop:my-6 laptop:pl-2'>
              ...
              <div key={item.id} photo={item.prod_img}  name={item.name}  brand={item.brand} price={item.price}   
                  ...
                  desktop:w-[370px] desktop:h-[370px] laptopL:w-[400px] laptopL:h-[400px] items-center laptop:w-[250px] laptop:h-[250px] md:w-[220px] md:h-[220px]'>
                <div className='flex flex-col laptopL:w-[500px] laptopL:h-[500px]' >
                  <Link to={`/products/${item.categories}/${item.id}`}>
                     <img className='desktop:h-[295px] desktop:w-[295px]
                      laptopL:w-[320px] laptopL:h-[320px] laptop:w-[185px] laptop:h-[185px] md:w-[130px] md:h-[130px]' alt={`${item.name} ${item.brand} $${item.price}`}  src={item.prod_img}/>
                  </Link>
                </div>   
