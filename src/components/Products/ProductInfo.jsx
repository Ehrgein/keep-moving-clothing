          ...
          item.id == productinfo ? (
            <div key={item.id} className="flex">
              ...
              <div className="flex flex-col desktop:ml-20 laptopL:ml-8 laptop:ml-12 desktop:mt-10 laptop:mt-6 4k:w-[38%] desktop:w-[35%] laptopL:w-[50%]">
                ...
                <h4 className="mt-2 text-center 4k:text-2xl 4k:h-14 desktop:text-xl laptopL:text-xl laptop:text-lg bg-yellow-500 text-black h-12 laptop:h-8 py-1 4k:w-auto desktop:w-[450px] laptopL:w-[320px]">
                  {" "}
                  Buy with Paypal
                </h4>
              </div>
