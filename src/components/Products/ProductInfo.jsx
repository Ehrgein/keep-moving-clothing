        ...
        <div className='hidden laptop:flex w-full h-auto bg-white flex-col items-center 4k:items-center mt-10 desktop:mt-20 desktop:mb-20 mb-10 ml-14'>
            ...
            <div key={item.id} className='flex'>
                <div className='flex justify-center w-[75%] flex-grow'>
                    <img className='4k:w-[690px] 4k:h-[690px] desktop:h-[560px] desktop:w-[560px] laptopL:w-[475px] laptopL:h-[475px] laptop:w-[400px] laptop:h-[400px]'
                    src={item.prod_img} alt={`${item.name} ${item.brand} $${item.price} ` }/>
                 </div>
                <div className='flex flex-col desktop:ml-20 laptopL:ml-8 laptop:ml-12 desktop:mt-10 laptop:mt-6 4k:w-[38%] desktop:w-[35%] laptopL:w-[50%]'>
                  <div className='flex w-full'>
                    <div className='flex'>
                      <h4 className='font-bold 4k:text-3xl desktop:text-2xl laptopL:text-xl laptop:text-xl capitalize 4k:w-[500px] desktop:w-[400px] laptopL:w-[335px] laptop:w-[300px]
                    ...
                    <div className='flex justify-start items-start'   onClick={() => cart.deleteFromWish(productinfo)} >
                      <button >
                        <FiHeart className='heart 4k:mb-1 laptop:mt-2  
                    ...
                    <IconContext.Provider value={{color:'black'}}>
                      <button>
                        <FiHeart className='4k:mb-1 laptop:mt-2
                         4k:w-[30px] 4k:h-[30px] desktop:w-[24px] desktop:h-[24px] laptopL:w-[20px] laptopL:h-[20px] laptop:w-[22px] laptop:h-[22px] laptopL:ml-2'/>
                      </button>
                    ...
                    <div>
                      <h1 className='flex mt-1 font-bold 4k:text-2xl laptopL:text-xl'> ${item.price}</h1>
                    </div>
                    ...
                    :
                    <div className='flex'>
                      <div className='rounded-full bg-red-500 desktop:w-[25px] desktop:h-[25px] laptopL:w-[20px] laptopL:h-[20px] laptop:w-[20px] laptop:h-[20px] mt-6'>
                      </div> 
                      <p className='mt-[20px] ml-2 4k:text-lg'>Out of stock</p>
                    </div>
                    }
                    <button onClick={AddCart}
                    className='uppercase laptop:mt-4 mt-10 text-center 4k:text-2xl desktop:text-xl laptopL:text-xl laptop:text-lg
                     bg-black text-white font-black 4k:h-14 desktop:h-8  laptop:h-8 h-12 desktop:py-1  4k:w-auto desktop:w-[450px]  laptopL:w-[320px]'>
                    add to cart
                    </button>
                    <h4 className='mt-2 text-center 4k:text-2xl 4k:h-14 desktop:text-xl laptopL:text-xl laptop:text-lg bg-yellow-500 text-black h-12 laptop:h-8 py-1 4k:w-auto desktop:w-[450px] laptopL:w-[320px]'> Buy with Paypal</h4>
                  </div>
