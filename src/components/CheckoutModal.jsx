    ...
    <div className='checkoutmodal fixed  inset-0 z-55 overflow-y-scroll'>
        ...
        <div className='h-screen flex justify-center  items-center text-black text-2xl ' >
          ...
          <div className='absolute top-0 right-0 mr-1 mt-1'>
            <button className='4k:text-2xl desktop:text-xl laptop:text-xl font-medium' onClick={() => setonPurchasemodal(false)} >Close</button>
          </div>
            <div className='flex flex-col justify-center items-center w-[100%] opacity-100 h-[100%] font-medium'>
                ...
                <div className='flex mobilexs:flex-col tablet:flex-row items-center'>
                  <FcCheckmark className='h-8 w-8 ml-2 tablet:hidden flex justify-center items-center'/>
                    <h1 className='laptopL:h-8 4k:text-2xl desktop:text-xl laptopL:text-lg font-medium tablet:text-xl mobilexs:text-lg'>Purchase successful, thank you!</h1>
                    <FcCheckmark className='h-8 4k:h-14 w-8 ml-2 mobilexs:hidden tablet:block'/>
                </div>
                <h1 className='mt-8 4k:text-2xl desktop:text-xl laptopL:text-lg tablet:text-xl mobilexs:text-lg font-medium'>You can find your purchase details 
                <Link className='text-[#0000FF] mobilexs:text-lg ml-2 4k:text-2xl desktop:text-xl' to={`/account/orders`}>
                   here
                  </Link>
                </h1> 
