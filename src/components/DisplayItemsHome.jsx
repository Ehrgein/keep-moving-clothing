  ...
  return (
    <div className="">
      ...
      <motion.div ref={carouseltwo} className="carousel">
        ...
        >
          {contextproducts
            ?.filter((item) => item.categories == props)
            .slice(0, 11)
            .map((item) => (
              <motion.div
            ...
            4k:my-20 4k:mx-16 desktop:mx-18 desktop:mt-14 text-sm laptopL:mx-12 laptopL:mt-8 laptop:mx-4 laptop:mt-8 md:mt-8 md:mx-2 mb-4 items-center ml-6"
              ...
              >
                <motion.div
                  className="4k:w-[350px] 4k:h-[350px] desktop:w-[300px] desktop:h-[300px] laptopL:w-[250px] laptopL:h-[250px]
               laptop:w-[220px] laptop:h-[220px] md:w-[230px] md:h-[230px]"
                ...
                <div className="my-6">
                  ...
                  <p className="text-base mt-1 text-center 4k:text-lg">
                    {" "}
                    $ {item.price}{" "}
                  </p>
                </div>
