    ...
    <div>
        ...
        <div className="flex md:flex my-4 gap-8 justify-center">
          <div className="relative">
            ...
            <div className="4k:w-[800px] 4k:h-[800px] desktop:w-[675px] desktop:h-[75px] laptopL:w-[450px] laptopL:h-[450px]  lg:w-[300px] lg:h-[300px] md:h-[230px] md:w-[230px] ">
              <img alt='new balance sneakers' src={newbalance1}/>
            </div>
          </div>
          <div className="relative">
            ...
            <div className="4k:w-[800px] 4k:h-[800px] desktop:w-[675px] desktop:h-[675px] laptopL:w-[450px] laptopL:h-[450px] lg:w-[300px] lg:h-[300px] md:h-[230px] md:w-[230px]  ">
              <img alt='nike louis vuitton sneakers' className="" src={nikelouis}/>
            </div>
          </div>
          <div className="relative">
            ...
            <div className="4k:w-[800px] 4k:h-[800px] desktop:w-[675px] desktop:h-[675px] laptopL:w-[450px] laptopL:h-[450px]  lg:w-[300px] lg:h-[300px] md:h-[230px] md:w-[230px] desktop:text-2xl 4k:text-4xl">
              <img alt='converse sneakers'src={converse}/>
            </div>
          </div>
        </div>
    </div>
