...
function DesktopHeader() {
  ...
  return (
    <div>      
        <Sliderbar/>
        <div className="hidden md:flex justify-between items-center 4k:h-24  h-20 text-white bg-black w-full px-20">
            <div className="flex justify-center desktop:w-[15%] desktop:tracking-widest md:w-[20%] font-bold">
                <Link onClick={() => cart.closeCart()} to="/">
                    <h1 className="4k:text-2xl desktop:text-xl laptopL:text-lg 2xl:text-sm py-2 px-2 border-2 border-white md:text-xl md:mt-1 md:ml-4 ml-10 mt-4">
                        K E E P M O V I N G
                    </h1>
                </Link>
            </div>
            <div className="hidden md:flex 4k:text-xl tracking-widest bg-black text-white justify-start h-10 items-end font-normal md:gap-3 gap-6  uppercase">
                <BrandDropDown/>
                <Link to="/newarrivals">
                    <p>LATEST</p>
                </Link>        
